...
<head>
    ...
    <script>
        ...
        function updateamp() {
            ...
            $('#updatefrom').form('load','/per/updatepage/'+users.permissionId);
        }
...
<div id="add" style="display: none;">
    <form id="ff" method="post">
        <table cellpadding="5">
            <tr>
                <td>权限编号：</td>
                <td><input class="easyui-textbox" type="text" name="permissionId" data-options="required:true"></input></td>
            </tr>
            <tr>
                <td>权限姓名：</td>
